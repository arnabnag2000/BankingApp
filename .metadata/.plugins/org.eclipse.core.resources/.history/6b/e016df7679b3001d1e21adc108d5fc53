...
import com.capg.customerservice.service.CustomerSupportService;
	...
	class CustomerServiceApplicationTests {
		...
		public void PostQuery() {	
			...
			CustomerSupport c = new CustomerSupport((long) 1,"arnabnag56@gmail.com","arnabnag2000@gmail.com","unsolved","9007456789","query",new Date()) ;
		...
		public void GetTask() {	
			...
			i.add(new CustomerSupport((long) 1,"arnabnag56@gmail.com","arnabnag2000@gmail.com","unsolved","9007456789","query",new Date()));
